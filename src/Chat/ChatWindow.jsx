...
export const ChatWindow = ({ currentUser, chatUser, onBack }) => {
  ...
  return (
    <div className="flex h-full flex-col bg-white">
      ...
      {/* Messages */}
      <div ref={scrollRef} className="chat-bg flex-1 overflow-y-auto px-3 py-3 space-y-1 scrollbar-thin sm:px-5 sm:py-4">
        {messages.length === 0 && (
      ...
      {/* Editing banner */}
      {editingMsg && (
        <div className="flex items-center justify-between border-t border-indigo-100 bg-indigo-50 px-5 py-2">
      ...
      {/* Input */}
      <div className="border-t border-slate-100 px-2.5 py-2.5 sm:px-4 sm:py-3">
        <form onSubmit={handleSend} className="flex items-end gap-1.5 sm:gap-2">
          ...
          <button
            ...
            disabled={uploading}
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 disabled:text-slate-300"
          >
            {uploading ? (
          ...
          <input
            ...
            className="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-700 outline-none placeholder:text-slate-400 transition focus:border-indigo-300 focus:bg-white focus:ring-2 focus:ring-indigo-100 sm:px-4"
          />
          ...
          <button
            ...
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-indigo-600 text-white shadow-sm transition hover:bg-indigo-700 active:scale-90 disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none"
          >
